...
II - A variável "contaPoupanca" possuíra os métodos "depositar", "retirar" e "exibirSaldo". 
Mas a implementação da função "exibirSaldo" não será sobrescrita, pois não é possível sobrescrever propriedades de um prototype.
...
contaPoupanca.depositar;contaPoupanca.retirar;contaPoupanca.exibirSaldo;
console.log(contaPoupanca.exibirSaldo());
console.log(contaPoupanca.rendimento);
console.log(contaPoupanca.__pro__.exibirSaldo());